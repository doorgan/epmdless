defmodule EPMDLess.NodePortMapper do
  use GenServer
  ...
  defp parent_node do
    if parent_node = System.get_env("EPMDLESS_PARENT_NODE") do
  ...
  def register() do
    GenServer.call({@name, parent_node()}, {:register, node(), EPMDLess.EPMD.dist_port()})
  end
